...
{
    //디버프카드 데이터
    public int debuffAmount;    // 디버프 수치
    public int duration;        // 지속 턴 수
    public int cost;            // 코스트
    public CardElement element; // 속성

    
    public DebuffCard(int _debuffAmount, int _duration, int _cost, CardElement _element)
    {
        this.debuffAmount = _debuffAmount;
